...
import {homepageThresholds } from '../scenarios/custom-threshholds.ts';
import {constantLoadScenario} from '../scenarios/traffic-workloads-scenario.ts';
import { errorRate, homepageDuration, homepageRequests } from '../src/utils/metrics.ts';
import { htmlReport } from 'https://raw.githubusercontent.com/benc-uk/k6-reporter/main/dist/bundle.js';
import { textSummary } from 'https://jslib.k6.io/k6-summary/0.1.0/index.js';
export const options: Options = {
  scenarios: { homepage_500_concurrent: constantLoadScenario },
...
export function handleSummary(data: unknown) {
  return {
    'reports/homepage-summary.html': htmlReport(data),
